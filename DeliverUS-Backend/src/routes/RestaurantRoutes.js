...
const loadFileRoutes = function (app) {
  app.route('/restaurants')
    ...
    .post(
      ...
      handleValidation,
      RestaurantMiddleware.checkFreeCommissionLimitDuringCreation,
  ...
  app.route('/restaurants/:restaurantId')
    ...
    .put(
      ...
      handleValidation,
      RestaurantMiddleware.checkNoOrdersWhenSwitchingToFree,
      RestaurantMiddleware.checkFreeCommissionLimitDuringUpdate,
